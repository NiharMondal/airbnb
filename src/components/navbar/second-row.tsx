                ...
                Notice same layoutId "centerMover" → framer morphs it between parents */}
					{(!isScrolled || isExpanded) && (
						<motion.div
							...
							key="secondSearch"
							variants={{
								initial: { opacity: 0, y: 0 }, // coming from slightly above when page loads
								animate: {
									opacity: 1,
									y: 0,
						...
						>
							...
							>
								<div className="flex items-center justify-between divide-gray-400 text-base font-medium h-full relative">
									<Popover
										open={openPopover === "where"}
										onOpenChange={(isOpen) =>
											handleOpenChange("where", isOpen)
										}
									>
										<PopoverTrigger
											className={cn(
										...
										>
											...
											<input
												...
												className="outline-0 border-0 py-1"
											/>
										</PopoverTrigger>
										<PopoverContent
