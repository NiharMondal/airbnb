...
export default function DesktopNavbar() {
	...
	// ✅ Logic: second row moves up only if scrolled & not force-expanded
	const movedUp = isScrolled && !forceExpanded;

	// ✅ Outside click detection when forceExpanded is true
	useEffect(() => {
	...
	return (
		<header
			className="sticky top-0 z-50 bg-[#fbfbfb] px-5 lg:px-12"
			ref={headerRef}
		>
			{/* Part 1 */}
